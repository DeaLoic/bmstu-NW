...
\begin{center}
	...
	{\bf\Large Вариант №14\par}
	\vspace{0.5cm}
\end{center}

\noindent
\makebox{\large{\bf Название:}~~~}
\makebox[\textwidth][l]{\large\underline{Настройка сетевых служб: DNS, HTTP, электронной~~~~}}
\makebox[\textwidth][l]{\large\underline{почты в сетевом эмуляторе~~~~~}}
